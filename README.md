...
....1Generate Developer Certificate: Enables secure HTTPS development.
```Bash
    dotnet dev-certs https --trust
```
....2Generate Migration: Creates the initial SQL blueprint from your C# models.
```Bash
    dotnet ef migrations add InitialCreate --project .\Champions.Api\
```
....3Run Application: Triggers the `DatabaseSeeder`, which reads your generated JSON files (Pokémon, Moves, Abilities, Items, and Custom Items) and injects them into `champions.db`.
```Bash
